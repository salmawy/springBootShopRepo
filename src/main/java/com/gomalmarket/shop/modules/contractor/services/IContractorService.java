...
public interface IContractorService {
	...
	public ContractorTransaction AddContractorTransaction(String name,int typeId,double amount,Fridage fridageId,String notes,int paid,int ownerId,Date date,Season season) throws DataBaseException, InvalidReferenceException ;
	...
	public ContractorTransaction editContractorTransaction(String name, int typeId, double amount, Fridage fridage, String notes, int paid,int ownerId, Date date, Season season, int trxId) throws DataBaseException, InvalidReferenceException;
}
